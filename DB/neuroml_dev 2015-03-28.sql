...
--
-- Dumping routines for database 'neuroml_dev'
--
/*!50003 DROP PROCEDURE IF EXISTS `boolean_search` */;
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`neuromldb2`@`localhost` PROCEDURE `boolean_search`(IN query_list varchar(1000))
begin
SELECT * FROM keyword_symbol_tables WHERE query_list;
END ;;
DELIMITER ;
...
BEGIN 
	 ...
	 IF cnt = 1 THEN
        ...
        FROM model_metadata_associations join neuroml_dev.references on metadata_id = reference_ID
		WHERE model_ID = parent_ID;
...
/*!50001 SET collation_connection      = utf8_general_ci */;
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`neuromldb2`@`%` SQL SECURITY DEFINER */
...
-- Dump completed on 2015-03-28 12:03:26
