...
--
-- Table structure for table `all_metadata_view`
--

DROP TABLE IF EXISTS `all_metadata_view`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `all_metadata_view` (
  `Model_ID` tinyint(4) NOT NULL,
  `Metadata_id` tinyint(4) NOT NULL,
  `Metadata_type` tinyint(4) NOT NULL,
  `Metadata_value` tinyint(4) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `all_metadata_view`
--

LOCK TABLES `all_metadata_view` WRITE;
/*!40000 ALTER TABLE `all_metadata_view` DISABLE KEYS */;
/*!40000 ALTER TABLE `all_metadata_view` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Temporary table structure for view `all_models`
--

DROP TABLE IF EXISTS `all_models`;
/*!50001 DROP VIEW IF EXISTS `all_models`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE TABLE `all_models` (
...
--
-- Table structure for table `all_models_view`
--

DROP TABLE IF EXISTS `all_models_view`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `all_models_view` (
  `Model_ID` tinyint(4) NOT NULL,
  `Model_Name` tinyint(4) NOT NULL,
  `Model_File` tinyint(4) NOT NULL,
  `upload_time` tinyint(4) NOT NULL,
  `comments` tinyint(4) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `all_models_view`
--

LOCK TABLES `all_models_view` WRITE;
/*!40000 ALTER TABLE `all_models_view` DISABLE KEYS */;
/*!40000 ALTER TABLE `all_models_view` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `author_list_associations` VALUES (1000001,2000001,'3',NULL),(1000001,2000002,'0',NULL),(1000001,2000003,'0',NULL),(1000001,2000004,'1',NULL),(1000002,2000004,'1',NULL),(1000002,2000005,'3',NULL),(1000002,2000006,'0',NULL),(1000003,2000004,'1',NULL),(1000003,2000006,'3',NULL),(1000003,2000007,'0',NULL),(1000035,2000004,'1',NULL),(1000036,2000004,'1',NULL),(1000037,2000004,'1',NULL),(1000037,2000009,'0',NULL),(1000037,2000010,'0',NULL),(1000037,2000036,'0',NULL),(1000037,2000038,'0',NULL),(1000037,2000039,'0',NULL),(1000037,2000040,'0',NULL),(1000038,2000004,'1',NULL),(1000038,2000009,'0',NULL),(1000038,2000010,'0',NULL),(1000038,2000036,'0',NULL),(1000038,2000038,'0',NULL),(1000038,2000039,'0',NULL),(1000038,2000040,'0',NULL),(1000039,2000004,'1',NULL),(1000039,2000009,'0',NULL),(1000039,2000010,'0',NULL),(1000039,2000036,'0',NULL),(1000039,2000038,'0',NULL),(1000039,2000039,'0',NULL),(1000039,2000040,'0',NULL),(1000041,2000004,'1',NULL),(1000041,2000010,'0',NULL),(1000041,2000013,'0',NULL),(1000041,2000036,'0',NULL),(1000041,2000038,'0',NULL),(1000041,2000039,'0',NULL),(1000041,2000040,'0',NULL),(1000043,2000004,'2',NULL),(1000043,2000018,'1',NULL),(1000043,2000019,'1',NULL),(1000044,2000004,'1',NULL),(1000044,2000010,'1',NULL),(1000044,2000020,'0',NULL),(1000045,2000014,'1',NULL),(1000045,2000021,'1',NULL),(1000045,2000025,'1',NULL),(1000045,2000026,'1',NULL),(1000046,2000014,'1',NULL),(1000046,2000021,'1',NULL),(1000046,2000025,'1',NULL),(1000046,2000026,'1',NULL),(1000046,2000027,'0',NULL),(1000047,2000004,'1',NULL),(1000051,2000004,'1',NULL

...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `keyword_view` AS select `mma`.`Model_ID` AS `Model_ID`,`ok`.`Other_Keyword_term` AS `Keywords` from ((`model_metadata_associations` `mma` join `other_keywords` `ok`) join `refers` `ref`) where (`ok`.`Other_Keyword_ID` = `mma`.`Metadata_ID`) union select `mma`.`Model_ID` AS `Model_ID`,concat(' ',ifnull(`pub`.`Full_Title`,''),' ',ifnull(`pub`.`Pubmed_Ref`,''),' ',ifnull(`pub`.`Comments`,'')) AS `Keywords` from (`model_metadata_associations` `mma` join `publications` `pub`) where (`pub`.`Publication_ID` = `mma`.`Metadata_ID`) union select `mma`.`Model_ID` AS `Model_ID`,concat(' ',ifnull(`nlx`.`NeuroLex_Term`,''),' ',ifnull(`nlx`.`NeuroLex_URI`,''),' ',ifnull(`nlx`.`Comments`,'')) AS `Name_exp_6` from (`model_metadata_associations` `mma` join `neurolexes` `nlx`) where (`nlx`.`NeuroLex_ID` = `mma`.`Metadata_ID`) union select `cells`.`Cell_ID` AS `Cell_ID`,concat(' ',ifnull(`cells`.`Cell_Name`,''),' ',ifnull(`cells`.`Comments`,'')) AS `concat(' ', IFNULL(Cell_Name,''), ' ', IFNULL(Comments,''))` from `cells` union select `networks`.`Network_ID` AS `Network_ID`,concat(' ',ifnull(`networks`.`Network_Name`,''),' ',ifnull(`networks`.`Comments`,'')) AS `concat(' ', IFNULL(Network_Name,''), ' ', IFNULL(Comments,''))` from `networks` union select `channels`.`Channel_ID` AS `Channel_ID`,concat(' ',ifnull(`channels`.`Channel_Name`,''),' ',ifnull(`channels`.`Comments`,'')) AS `concat(' ', IFNULL(Channel_Name,''), ' ', IFNULL(Comments,''))` from `channels` union select `synapses`.`Synapse_ID` AS `Synapse_ID`,concat(' ',ifnull(`synapses`.`Synapse_Name`,''),' ',ifnull(`synapses`.`Comments`,'')) AS `concat(' ', IFNULL(Synapse_Name,''), ' ', IFNULL(Comments,''))` from `synapses` union select `mma`.`Model_ID` AS `Model_ID`,concat(' ',ifnull(`ppl`.`Person_First_Name`,''),' ',ifnull(`ppl`.`Person_Last_Name`,''),' ',ifnull(`ppl`.`Instituition`,''),' ',ifnull(`ppl`.`Comments`,'')) AS `Name_exp_16` from ((`people` `ppl` join `model_metadata_associations` `mma`) join `author_list_associations` `ala`) where ((`mma`.`Metadata_ID` = `ala`.`AuthorList_ID`) and (`ala`.`Person_ID` = `ppl`.`Person_ID`)) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `partof_tables` AS select `cell_channel_associations`.`Cell_ID` AS `parent`,`cell_channel_associations`.`Channel_ID` AS `child` from `cell_channel_associations` union select `cell_synapse_associations`.`Cell_ID` AS `parent`,`cell_synapse_associations`.`Synapse_ID` AS `child` from `cell_synapse_associations` union select `network_cell_associations`.`Network_ID` AS `parent`,`network_cell_associations`.`Cell_ID` AS `child` from `network_cell_associations` union select `network_synapse_associations`.`Network_ID` AS `parent`,`network_synapse_associations`.`Synapse_ID` AS `child` from `network_synapse_associations` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2015-03-28 17:51:17
