...
#-----------
SET @nextId = (SELECT Person_ID FROM neuroml_dev.people order by Person_ID desc Limit 1) + 1;
...
SET @nextId = (SELECT Reference_ID FROM neuroml_dev.`refers` order by Reference_ID desc Limit 1) + 1;
INSERT INTO metadatas SET Metadata_id = @nextId;
INSERT INTO neuroml_dev.`refers` SET Reference_ID = @nextId, Reference_Resource = 'Open Source Brain', Reference_URI = 'http://www.opensourcebrain.org/projects/l5bpyrcellhayetal2011';
INSERT INTO model_metadata_associations SET Metadata_id = @nextId, Model_ID = 'NMLCL000073';

#-----------

UPDATE `neuroml_dev`.`model_metadata_associations` SET `Metadata_ID`='5000190' WHERE `Metadata_ID`='5000191' and`Model_ID`='NMLCH000067' limit 1;
...
DELETE FROM `neuroml_dev`.`author_list_associations` WHERE `AuthorList_ID`='1000176' and`Person_ID`='2000040' limit 1;

UPDATE `neuroml_dev`.`author_list_associations` SET `is_translator`='2' WHERE `AuthorList_ID`='1000176' and`Person_ID`='2000028';
...
INSERT INTO `neuroml_dev`.`author_list_associations` (`AuthorList_ID`, `Person_ID`, `is_translator`) VALUES ('1000176', '2000014', '1');
INSERT INTO `neuroml_dev`.`author_list_associations` (`AuthorList_ID`, `Person_ID`, `is_translator`) VALUES ('1000176', '2000015', '1');
