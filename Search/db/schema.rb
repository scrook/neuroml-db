...
ActiveRecord::Schema.define(:version => 20130419200535) do
  ...
  create_table "kcategories", :force => true do |t|
  ...
  add_index "keyword_symbol_tables", ["Keyword"], :name => "keyword", :length => 10
  add_index "keyword_symbol_tables", ["Model_ID"], :name => "model_ID"

  create_table "kkeywords", :force => true do |t|
  ...
  create_table "modeluploads", :primary_key => "SubmissionID", :force => true do |t|
    t.string "FirstName",   :limit => 45, :null => false
    t.string "MiddleName",  :limit => 45
    t.string "LastName",    :limit => 45
    t.string "ModelName",   :limit => 45, :null => false
    t.string "Email",       :limit => 45, :null => false
    t.string "Institution", :limit => 45, :null => false
    t.text   "Publication"
    t.text   "Modelref"
    t.text   "Description"
    t.string "Modelspath",  :limit => 45, :null => false
    t.text   "Keywords"
    t.text   "Comments"
    t.text   "Contributor"
  end
  ...
  create_table "neurolexes", :primary_key => "NeuroLex_ID", :force => true do |t|
    t.string "NeuroLex_URI",  :limit => 500, :null => false
    t.string "NeuroLex_Term", :limit => 250, :null => false
    t.string "Comments",      :limit => 500
  end

  add_index "neurolexes", ["NeuroLex_ID"], :name => "FK_Meta_NeuroLex_idx"
