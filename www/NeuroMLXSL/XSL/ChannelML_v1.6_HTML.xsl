...
<!--
    ...
    This file is used to convert v1.6 ChannelML files to a "neuroscientist friendly" HTML view
...
<xsl:template match="cml:status">
    <xsl:call-template name="tableRow">
            ...
            <xsl:with-param name="comment">Status of channel specification</xsl:with-param>
