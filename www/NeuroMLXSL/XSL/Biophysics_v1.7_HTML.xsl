...
<!--
    ...
    This file is used to convert v1.7 Biophysics info to a "neuroscientist friendly" HTML view
...
<xsl:template match="bio:mechanism">
    ...
    <xsl:when test="@type='Channel Mechanism'">
        <xsl:call-template name="tableRow">
            ...
            <xsl:if test="count(@passiveConductance) &gt; 0 and ( @passiveConductance='true' or @passiveConductance='1')">
...
<xsl:template match="bio:specificCapacitance">
...
<xsl:template match="bio:specificAxialResistance">
...
<xsl:template match="bio:initialMembPotential">
