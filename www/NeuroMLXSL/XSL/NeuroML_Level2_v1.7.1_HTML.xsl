...
<xsl:stylesheet version="1.0"
    ...
    <xsl:import href="Biophysics_v1.7.1_HTML.xsl"/>
    <xsl:import href="ChannelML_v1.7.1_HTML.xsl"/>

<!--

    This file is used to convert v1.7.1 MorphML files to a "neuroscientist friendly" view
...
<h3>NeuroML v1.7.1 Level 2 file</h3>
