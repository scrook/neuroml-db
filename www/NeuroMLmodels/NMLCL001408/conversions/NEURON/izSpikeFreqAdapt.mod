TITLE Mod file for component: Component(id=izSpikeFreqAdapt type=izhikevichCell)
...
NEURON {
    POINT_PROCESS izSpikeFreqAdapt
...
PROCEDURE rates() {
    ...
    ? DerivedVariable is based on path: synapses[*]/I, on: Component(id=izSpikeFreqAdapt type=izhikevichCell), from synapses; null
