TITLE Mod file for component: Component(id=izPhasicBursting type=izhikevichCell)
...
NEURON {
    POINT_PROCESS izPhasicBursting
...
PROCEDURE rates() {
    ...
    ? DerivedVariable is based on path: synapses[*]/I, on: Component(id=izPhasicBursting type=izhikevichCell), from synapses; null
