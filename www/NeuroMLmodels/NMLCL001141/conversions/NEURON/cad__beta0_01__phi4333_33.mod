TITLE Mod file for component: Component(id=cad__beta0_01__phi4333_33 type=fixedFactorConcentrationModelTraub)
...
NEURON {
    SUFFIX cad__beta0_01__phi4333_33
