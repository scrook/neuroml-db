TITLE Mod file for component: Component(id=izThVar type=izhikevichCell)
...
PROCEDURE rates() {
    ...
    ? DerivedVariable is based on path: synapses[*]/I, on: Component(id=izThVar type=izhikevichCell), from synapses; null
