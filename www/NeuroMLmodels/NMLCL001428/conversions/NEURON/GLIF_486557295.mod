TITLE Mod file for component: Component(id=GLIF_486557295 type=glifCell)
...
PARAMETER {
    ...
    leakConductance = 0.005439808 (uS)
    leakReversal = 0 (mV)
    thresh = 24.445694 (mV)
    reset = 0 (mV)
    C = 1.1567298E-4 (microfarads)
}
...
PROCEDURE rates() {
    ...
    ? DerivedVariable is based on path: synapses[*]/i, on: Component(id=GLIF_486557295 type=glifCell), from synapses; null
