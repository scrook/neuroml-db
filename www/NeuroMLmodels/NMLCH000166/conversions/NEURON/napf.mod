...
PROCEDURE rates() {
    ...
    ? DerivedVariable is based on path: steadyState/x, on: Component(id=m type=gateHHtauInf), from steadyState; Component(id=null type=napf__a0__b0__c0__d0__fastNa_shiftmin2_5__a0__b0__c0__d0__fastNa_shiftmin2_5__a0__b0__c0__d0__fastNa_shiftmin2_5__a0__b0__c0__d0__fastNa_shiftmin2_5_m_inf_inf)
    m_inf = m_steadyState_x ? path based, prefix = m_
    
    ? DerivedVariable is based on path: timeCourse/t, on: Component(id=m type=gateHHtauInf), from timeCourse; Component(id=null type=napf__a0__b0__c0__d0__fastNa_shiftmin2_5__a0__b0__c0__d0__fastNa_shiftmin2_5__a0__b0__c0__d0__fastNa_shiftmin2_5__a0__b0__c0__d0__fastNa_shiftmin2_5_m_tau_tau)
