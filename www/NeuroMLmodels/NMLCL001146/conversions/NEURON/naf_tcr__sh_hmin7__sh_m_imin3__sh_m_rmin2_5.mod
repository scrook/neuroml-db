TITLE Mod file for component: Component(id=naf_tcr__sh_hmin7__sh_m_imin3__sh_m_rmin2_5 type=ionChannelHH)
...
NEURON {
    SUFFIX naf_tcr__sh_hmin7__sh_m_imin3__sh_m_rmin2_5
...
PARAMETER {
    ...
    m_timeCourse_sh_m_i = -3 
    m_timeCourse_sh_m_r = -2.5 
    m_timeCourse_sh_h = -7 
    m_steadyState_TIME_SCALE = 1 (ms)
    m_steadyState_VOLT_SCALE = 1 (mV)
    m_steadyState_sh_m_i = -3 
    m_steadyState_sh_m_r = -2.5 
    m_steadyState_sh_h = -7 
    h_instances = 1 
    h_timeCourse_TIME_SCALE = 1 (ms)
    h_timeCourse_VOLT_SCALE = 1 (mV)
    h_timeCourse_sh_m_i = -3 
    h_timeCourse_sh_m_r = -2.5 
    h_timeCourse_sh_h = -7 
    h_steadyState_TIME_SCALE = 1 (ms)
    h_steadyState_VOLT_SCALE = 1 (mV)
    h_steadyState_sh_m_i = -3 
    h_steadyState_sh_m_r = -2.5 
    h_steadyState_sh_h = -7 
}
...
BREAKPOINT {
    ...
    ? DerivedVariable is based on path: conductanceScaling[*]/factor, on: Component(id=naf_tcr__sh_hmin7__sh_m_imin3__sh_m_rmin2_5 type=ionChannelHH), from conductanceScaling; null
    ? Path not present in component, using factor: 1
    
    conductanceScale = 1 
    
    ? DerivedVariable is based on path: gates[*]/fcond, on: Component(id=naf_tcr__sh_hmin7__sh_m_imin3__sh_m_rmin2_5 type=ionChannelHH), from gates; Component(id=m type=gateHHtauInf)
...
PROCEDURE rates() {
    ...
    ? DerivedVariable is based on path: steadyState/x, on: Component(id=m type=gateHHtauInf), from steadyState; Component(id=null type=naf_tcr__sh_hmin7__sh_m_imin3__sh_m_rmin2_5__sh_hmin7__sh_m_imin3__sh_m_rmin2_5__sh_hmin7__sh_m_imin3__sh_m_rmin2_5_m_inf_inf)
    m_inf = m_steadyState_x ? path based, prefix = m_
    
    ? DerivedVariable is based on path: timeCourse/t, on: Component(id=m type=gateHHtauInf), from timeCourse; Component(id=null type=naf_tcr__sh_hmin7__sh_m_imin3__sh_m_rmin2_5__sh_hmin7__sh_m_imin3__sh_m_rmin2_5__sh_hmin7__sh_m_imin3__sh_m_rmin2_5_m_tau_tau)
    ...
    ? DerivedVariable is based on path: steadyState/x, on: Component(id=h type=gateHHtauInf), from steadyState; Component(id=null type=naf_tcr__sh_hmin7__sh_m_imin3__sh_m_rmin2_5__sh_hmin7__sh_m_imin3__sh_m_rmin2_5__sh_hmin7__sh_m_imin3__sh_m_rmin2_5_h_inf_inf)
    h_inf = h_steadyState_x ? path based, prefix = h_
    
    ? DerivedVariable is based on path: timeCourse/t, on: Component(id=h type=gateHHtauInf), from timeCourse; Component(id=null type=naf_tcr__sh_hmin7__sh_m_imin3__sh_m_rmin2_5__sh_hmin7__sh_m_imin3__sh_m_rmin2_5__sh_hmin7__sh_m_imin3__sh_m_rmin2_5_h_tau_tau)
