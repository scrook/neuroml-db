TITLE Mod file for component: Component(id=cad__beta0_05__phi104000 type=fixedFactorConcentrationModelTraub)
...
NEURON {
    SUFFIX cad__beta0_05__phi104000
