TITLE Mod file for component: Component(id=napf_tcr__a0__b0__c0__d0__fastNa_shift7 type=ionChannelHH)
...
NEURON {
    SUFFIX napf_tcr__a0__b0__c0__d0__fastNa_shift7
...
BREAKPOINT {
    ...
    ? DerivedVariable is based on path: conductanceScaling[*]/factor, on: Component(id=napf_tcr__a0__b0__c0__d0__fastNa_shift7 type=ionChannelHH), from conductanceScaling; null
    ? Path not present in component, using factor: 1
    
    conductanceScale = 1 
    
    ? DerivedVariable is based on path: gates[*]/fcond, on: Component(id=napf_tcr__a0__b0__c0__d0__fastNa_shift7 type=ionChannelHH), from gates; Component(id=m type=gateHHtauInf)
...
PROCEDURE rates() {
    ...
    ? DerivedVariable is based on path: steadyState/x, on: Component(id=m type=gateHHtauInf), from steadyState; Component(id=null type=napf_tcr__a0__b0__c0__d0__fastNa_shift7__a0__b0__c0__d0__fastNa_shift7__a0__b0__c0__d0__fastNa_shift7__a0__b0__c0__d0__fastNa_shift7__a0__b0__c0__d0__fastNa_shift7_m_inf_inf)
    m_inf = m_steadyState_x ? path based, prefix = m_
    
    ? DerivedVariable is based on path: timeCourse/t, on: Component(id=m type=gateHHtauInf), from timeCourse; Component(id=null type=napf_tcr__a0__b0__c0__d0__fastNa_shift7__a0__b0__c0__d0__fastNa_shift7__a0__b0__c0__d0__fastNa_shift7__a0__b0__c0__d0__fastNa_shift7__a0__b0__c0__d0__fastNa_shift7_m_tau_tau)
