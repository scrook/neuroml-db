TITLE Mod file for component: Component(id=izReboundSpike type=izhikevichCell)
...
PROCEDURE rates() {
    ...
    ? DerivedVariable is based on path: synapses[*]/I, on: Component(id=izReboundSpike type=izhikevichCell), from synapses; null
