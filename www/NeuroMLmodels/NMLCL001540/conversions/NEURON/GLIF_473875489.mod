TITLE Mod file for component: Component(id=GLIF_473875489 type=glifRCell)
...
PARAMETER {
    ...
    leakConductance = 0.0039774934 (uS)
    leakReversal = 0 (mV)
    bs = 0.03353481 (kHz)
    deltaThresh = 2.3246198 (mV)
    deltaV = 4.175364 (mV)
    fv = 0.20256618 
    thresh = 28.166988 (mV)
    reset = 0 (mV)
    C = 7.855128E-5 (microfarads)
}
...
PROCEDURE rates() {
    ...
    ? DerivedVariable is based on path: synapses[*]/i, on: Component(id=GLIF_473875489 type=glifRCell), from synapses; null
