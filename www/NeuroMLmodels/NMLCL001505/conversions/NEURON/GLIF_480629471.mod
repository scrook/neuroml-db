TITLE Mod file for component: Component(id=GLIF_480629471 type=glifCell)
...
PROCEDURE rates() {
    ...
    ? DerivedVariable is based on path: synapses[*]/i, on: Component(id=GLIF_480629471 type=glifCell), from synapses; null
