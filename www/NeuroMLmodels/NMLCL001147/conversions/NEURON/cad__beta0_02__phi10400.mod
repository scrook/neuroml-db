TITLE Mod file for component: Component(id=cad__beta0_02__phi10400 type=fixedFactorConcentrationModelTraub)
...
NEURON {
    SUFFIX cad__beta0_02__phi10400
