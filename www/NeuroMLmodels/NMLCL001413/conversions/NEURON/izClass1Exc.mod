TITLE Mod file for component: Component(id=izClass1Exc type=generalizedIzhikevichCell)
...
PROCEDURE rates() {
    ...
    ? DerivedVariable is based on path: synapses[*]/I, on: Component(id=izClass1Exc type=generalizedIzhikevichCell), from synapses; null
