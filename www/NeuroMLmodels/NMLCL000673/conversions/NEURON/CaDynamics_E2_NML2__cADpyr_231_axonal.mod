TITLE Mod file for component: Component(id=CaDynamics_E2_NML2__cADpyr_231_axonal type=concentrationModelHayEtAl)
...
NEURON {
    SUFFIX CaDynamics_E2_NML2__cADpyr_231_axonal
