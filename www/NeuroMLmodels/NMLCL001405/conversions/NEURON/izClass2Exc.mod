TITLE Mod file for component: Component(id=izClass2Exc type=izhikevichCell)
...
PROCEDURE rates() {
    ...
    ? DerivedVariable is based on path: synapses[*]/I, on: Component(id=izClass2Exc type=izhikevichCell), from synapses; null
