...
BREAKPOINT {
    ...
    ? DerivedVariable is based on path: conductanceScaling[*]/factor, on: Component(id=ca type=ionChannelHH), from conductanceScaling; Component(id=null type=q10ConductanceScaling)
