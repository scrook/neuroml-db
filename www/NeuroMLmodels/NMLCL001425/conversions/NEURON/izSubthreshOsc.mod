TITLE Mod file for component: Component(id=izSubthreshOsc type=izhikevichCell)
...
PROCEDURE rates() {
    ...
    ? DerivedVariable is based on path: synapses[*]/I, on: Component(id=izSubthreshOsc type=izhikevichCell), from synapses; null
