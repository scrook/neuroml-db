TITLE Mod file for component: Component(id=napf_spinstell__a0__b0__c0__d0__shmin2_5 type=ionChannelHH)
...
NEURON {
    SUFFIX napf_spinstell__a0__b0__c0__d0__shmin2_5
    ...
    RANGE m_steadyState_sh                  : parameter
...
BREAKPOINT {
    ...
    ? DerivedVariable is based on path: conductanceScaling[*]/factor, on: Component(id=napf_spinstell__a0__b0__c0__d0__shmin2_5 type=ionChannelHH), from conductanceScaling; null
    ? Path not present in component, using factor: 1
    
    conductanceScale = 1 
    
    ? DerivedVariable is based on path: gates[*]/fcond, on: Component(id=napf_spinstell__a0__b0__c0__d0__shmin2_5 type=ionChannelHH), from gates; Component(id=m type=gateHHtauInf)
...
PROCEDURE rates() {
    ...
    if ((  m_timeCourse_V  +  m_timeCourse_sh  )  < ( -30 ))  { 
        m_timeCourse_t = ( 0.025 + 0.14 * ( exp ( (( m_timeCourse_V  +  m_timeCourse_sh ) + 30) / 10) ) ) *  m_timeCourse_TIME_SCALE ? evaluable cdv
    } else  { 
        m_timeCourse_t = ( 0.02 +  m_timeCourse_a  + (0.145 +  m_timeCourse_b ) * ( exp ( -1 * (( m_timeCourse_V  +  m_timeCourse_sh  +  m_timeCourse_d ) + 30) / (10 +  m_timeCourse_c )) )) *  m_timeCourse_TIME_SCALE ? evaluable cdv
    }
    
    m_steadyState_V = v /  m_steadyState_VOLT_SCALE ? evaluable
    m_steadyState_x = 1 / ( 1 + (exp ( ( -1 * ( m_steadyState_V  +  m_steadyState_sh ) - 38) / 10)) ) ? evaluable
    ...
    ? DerivedVariable is based on path: steadyState/x, on: Component(id=m type=gateHHtauInf), from steadyState; Component(id=null type=napf_spinstell__a0__b0__c0__d0__shmin2_5__a0__b0__c0__d0__shmin2_5__a0__b0__c0__d0__shmin2_5__a0__b0__c0__d0__shmin2_5__a0__b0__c0__d0__shmin2_5_m_inf_inf)
    m_inf = m_steadyState_x ? path based, prefix = m_
    
    ? DerivedVariable is based on path: timeCourse/t, on: Component(id=m type=gateHHtauInf), from timeCourse; Component(id=null type=napf_spinstell__a0__b0__c0__d0__shmin2_5__a0__b0__c0__d0__shmin2_5__a0__b0__c0__d0__shmin2_5__a0__b0__c0__d0__shmin2_5__a0__b0__c0__d0__shmin2_5_m_tau_tau)
