TITLE Mod file for component: Component(id=izReboundBurst type=izhikevichCell)
...
PROCEDURE rates() {
    ...
    ? DerivedVariable is based on path: synapses[*]/I, on: Component(id=izReboundBurst type=izhikevichCell), from synapses; null
