TITLE Mod file for component: Component(id=izAccomodation type=accomodationIzhikevichCell)
...
PROCEDURE rates() {
    ...
    ? DerivedVariable is based on path: synapses[*]/I, on: Component(id=izAccomodation type=accomodationIzhikevichCell), from synapses; null
    ...
    rate_U = a  * (  b   * ( (v /   MVOLT  ) +65) ) /  MSEC ? Note units of all quantities used here need to be consistent!
