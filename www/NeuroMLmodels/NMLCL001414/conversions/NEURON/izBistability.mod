TITLE Mod file for component: Component(id=izBistability type=izhikevichCell)
...
PROCEDURE rates() {
    ...
    ? DerivedVariable is based on path: synapses[*]/I, on: Component(id=izBistability type=izhikevichCell), from synapses; null
