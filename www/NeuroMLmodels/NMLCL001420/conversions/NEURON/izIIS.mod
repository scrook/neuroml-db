TITLE Mod file for component: Component(id=izIIS type=izhikevichCell)
...
PROCEDURE rates() {
    ...
    ? DerivedVariable is based on path: synapses[*]/I, on: Component(id=izIIS type=izhikevichCell), from synapses; null
