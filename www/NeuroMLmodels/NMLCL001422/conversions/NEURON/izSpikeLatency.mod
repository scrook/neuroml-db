TITLE Mod file for component: Component(id=izSpikeLatency type=izhikevichCell)
...
PROCEDURE rates() {
    ...
    ? DerivedVariable is based on path: synapses[*]/I, on: Component(id=izSpikeLatency type=izhikevichCell), from synapses; null
