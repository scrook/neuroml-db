TITLE Mod file for component: Component(id=CELL_CT type=izhikevich2007Cell)
...
PROCEDURE rates() {
    ...
    ? DerivedVariable is based on path: synapses[*]/i, on: Component(id=CELL_CT type=izhikevich2007Cell), from synapses; null
