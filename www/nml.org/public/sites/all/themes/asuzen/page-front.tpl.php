...
<style media="screen" type="text/css">
    @import "/sites/all/themes/asuzen/custom-front.css";
  </style>

<!--[if lte IE 6]>
<link rel="stylesheet" type="text/css" href="<?php echo base_path() . path_to_theme() . "/ie6-front.css"; ?>" />
<![endif]-->
<!--[if gte IE 7]>
<link rel="stylesheet" type="text/css" href="<?php echo base_path() . path_to_theme() . "/ie7-front.css"; ?>" />
<![endif]-->
<!--[if IE 8]>
<link rel="stylesheet" type="text/css" href="<?php echo base_path() . path_to_theme() . "/ie8-front.css"; ?>" />
<![endif]-->
