...
#  root :to => 'welcome#index', :as => 'home'
  match 'home', :to => 'welcome#browse_models', :as => 'home'
 root :to => 'account#login', :as => 'login'
match 'neuromlv2', :to => 'welcome#neuromlv2', :as => 'neuromlv2'
  ...
  match 'new_publication', :to => 'welcome#new_publication', :as => 'new_publication'
  match 'new_keywords', :to => 'welcome#new_keywords', :as => 'new_keywords'
  match 'new_reference', :to => 'welcome#new_reference',:as => 'new_reference'
  match 'new_author', :to => 'welcome#new_author',:as => 'new_author'
  match 'new_neurolex', :to => 'welcome#new_neurolex',:as => 'new_neurolex'
  match 'sessions_path', :to => 'sessions#new', :as => 'sessions_path'
  match 'browse_models', :to => 'welcome#browse_models', :as => 'browse_models'
  match 'list_models', :to => 'welcome#list_models', :as => 'list_models'
  match 'model_submit', :to => 'welcome#model_submit', :as => 'model_submit'
  match 'add_cell', :to => 'welcome#add_cell', :as => 'add_cell'
  match 'edit_cell', :to => 'welcome#edit_cells', :as => 'edit_cell'
  match 'edit_channel', :to => 'welcome#edit_channel', :as => 'edit_channel'
  match 'edit_network', :to => 'welcome#edit_network', :as => 'edit_network'
  match 'edit_synapse', :to => 'welcome#edit_synapse', :as => 'edit_synapse'
  match 'add_model', :to => 'welcome#add_model', :as => 'add_model'
  match 'curate_model', :to => 'welcome#curate_model', :as => 'curate_model'
  match 'search_result', :to => 'welcome#search_result', :as => 'search_result'
  match 'edit_model',:to=> 'welcome#edit_models', :as => 'edit_models'
  match 'add_curate_model', :to => 'welcome#add_curate_model', :as => 'add_curate_model'
  match 'edit_curate_model', :to => 'welcome#edit_curate_model', :as => 'edit_curate_model'
  match 'edit_cells_info', :to=>'welcome#edit_cells_info', :as => 'edit_cells_info'
  match 'submit_models', :to=>'welcome#submit_models', :as => 'submit_models'
  match 'add_publication', :to => 'welcome#add_publication', :as => 'add_publication' 
  match 'add_neurolex', :to => 'welcome#add_neurolex' , :as => 'add_neurolex'
  match 'add_references', :to => 'welcome#add_references', :as => 'add_references'
  match 'add_author', :to => 'welcome#add_author', :as => 'add_author'
  match 'add_keywords', :to => 'welcome#add_keywords', :as => 'add_keywords' 
  match 'edit_channels_info', :to=>'welcome#edit_channels_info', :as => 'edit_channels_info'
  match 'edit_networks_info', :to=>'welcome#edit_networks_info', :as => 'edit_networks_info'
  match 'edit_synapses_info', :to=>'welcome#edit_synapses_info', :as => 'edit_synapses_info'
  match 'edit_publication' , :to => 'welcome#edit_publication', :as => 'edit_model_info'
  match 'edit_author_details' , :to => 'welcome#edit_author_details', :as => 'edit_author_details'
  match 'edit_keywords', :to => 'welcome#edit_keywords', :as => 'edit_model_info'
  match 'edit_references', :to => 'welcome#edit_references', :as => 'edit_model_info'
  match 'edit_neurolex_terms', :to => 'welcome#edit_neurolex_terms' ,:as => 'edit_model_info'
  match 'add_cell_synapse_associations', :to => 'welcome#add_cell_synapse_associations', :as => 'edit_model_info'
  match 'add_cell_channel_associations', :to => 'welcome#add_cell_channel_associations', :as => 'edit_model_info'
  match 'add_cell_network_associations', :to => 'welcome#add_cell_network_associations', :as => 'edit_model_info'
  match 'add_synapse_cell_associations', :to => 'welcome#add_synapse_cell_associations', :as => 'edit_model_info'
  match 'add_synapse_network_associations', :to => 'welcome#add_synapse_network_associations', :as => 'edit_model_info'
  match 'add_network_synapse_associations', :to => 'welcome#add_network_synapse_associations', :as => 'edit_model_info'
  match 'add_network_cell_associations', :to => 'welcome#add_network_cell_associations', :as => 'edit_model_info'
  match 'add_channel_cell_associations', :to => 'welcome#add_channel_cell_associations', :as => 'edit_model_info'
  match 'del_cell_channel_associations', :to => 'welcome#del_cell_channel_associations', :as => 'edit_model_info'
  match 'del_cell_network_associations', :to => 'welcome#del_cell_network_associations', :as => 'edit_model_info'
  match 'del_cell_synapse_associations', :to => 'welcome#del_cell_synapse_associations', :as => 'edit_model_info'
  match 'del_synapse_cell_associations', :to => 'welcome#del_synapse_cell_associations', :as => 'edit_model_info'
  match 'del_synapse_network_associations', :to => 'welcome#del_synapse_network_associations', :as => 'edit_model_info'
  match 'del_channel_cell_associations', :to => 'welcome#del_channel_cell_associations', :as => 'edit_model_info'
  match 'del_network_synapse_associations', :to => 'welcome#del_network_synapse_associations', :as => 'edit_model_info'
  match 'del_network_cell_associations', :to => 'welcome#del_network_cell_associations', :as => 'edit_model_info'
