...
extern Memb_func* memb_func;
 ...
 "setdata_ca_tester", _hoc_setdata,
 0, 0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_prop_size(_mechtype, 7, 4);
 	...
 	ivoc_help("help ?1 ca_tester /home/justas/Repositories/neuroml-db/Import Scripts/model-importer/x86_64/ca_tester.mod\n");
 hoc_register_limits(_mechtype, _hoc_parm_limits);
 hoc_register_units(_mechtype, _hoc_parm_units);
 }
static int _reset;
static char *modelname = "Ca++ tester";
...
static void _initlists(){
 ...
 int _i; static int _first = 1;
  if (!_first) return;
 _slist1[0] = &(test) - _p;  _dlist1[0] = &(Dtest) - _p;
 _slist2[0] = &(test) - _p;
_first = 0;
}
