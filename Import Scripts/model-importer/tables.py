...
class Cells(BaseModel):
    ...
    AP12AmplitudeDrop = FloatField()
    AP1SSAmplitudeChange = FloatField()
    AP1Amplitude = FloatField()
    AP1WidthHalfHeight = FloatField()
    AP1WidthPeakToTrough = FloatField()
    AP1RateOfChangePeakToTrough = FloatField()
    AP1AHPDepth = FloatField()
    AP2Amplitude = FloatField()
    AP2WidthHalfHeight = FloatField()
    AP2WidthPeakToTrough = FloatField()
    AP2RateOfChangePeakToTrough = FloatField()
    AP2AHPDepth = FloatField()
    AP12AmplitudeChangePercent = FloatField()
    AP12HalfWidthChangePercent = FloatField()
    AP12RateOfChangePeakToTroughPercentChange = FloatField()
    AP12AHPDepthPercentChange = FloatField()
    InputResistance = FloatField()
    AP1DelayMean = FloatField()
    AP1DelaySD = FloatField()
    AP2DelayMean = FloatField()
    AP2DelaySD = FloatField()
    Burst1ISIMean = FloatField()
    Burst1ISISD = FloatField()
    InitialAccommodationMean = FloatField()
    SSAccommodationMean = FloatField()
    AccommodationRateToSS = FloatField()
    AccommodationAtSSMean = FloatField()
    AccommodationRateMeanAtSS = FloatField()
    ISICV = FloatField()
    ISIMedian = FloatField()
    ISIBurstMeanChange = FloatField()
    SpikeRateStrongStim = FloatField()
    AP1DelayMeanStrongStim = FloatField()
    AP1DelaySDStrongStim = FloatField()
    AP2DelayMeanStrongStim = FloatField()
    AP2DelaySDStrongStim = FloatField()
