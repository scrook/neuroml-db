...
-->
        ...
        <xsl:template match="/cml:channelml" >
                ...
                <xsl:element name="neuroml" namespace="http://www.neuroml.org/schema/neuroml2">
                        ...
                        <xsl:attribute name="schemaLocation" namespace="http://www.w3.org/2001/XMLSchema-instance">http://www.neuroml.org/schema/neuroml2 http://neuroml.svn.sourceforge.net/viewvc/neuroml/NeuroML2/Schemas/NeuroML2/NeuroML_v2alpha.xsd</xsl:attribute>
                        ...
                        <xsl:for-each select="cml:channel_type/cml:current_voltage_relation/cml:gate/cml:transition |
                                ...
                                <xsl:if test="@expr_form = 'generic'">
                                        ...
                                        <xsl:value-of select="$indent1_"/><xsl:element name="ComponentType" >
                                                ...
                                                <xsl:if test="count(../../../cml:parameters) &gt; 0">
                                                    <xsl:for-each select="../../../cml:parameters/cml:parameter">
                                                        <xsl:value-of select="$indent2"/><xsl:element name="Constant">
                                                            ...
                                                            <xsl:value-of select="$indent3"/><xsl:comment>Note: this parameter should instead be defined only once within the ionChannel!</xsl:comment><xsl:value-of select="$indent2"/>
                                                        </xsl:element>
                                                    </xsl:for-each>
                                                </xsl:if>
                                                ...
                                                <xsl:value-of select="$indent2_"/><xsl:element name="Behavior" >
                                                    ...
                                                    <xsl:variable name="value">
                                                        <xsl:choose>
                                                            <xsl:when test="contains(@expr, $temp_adj_factor)">
                                                        ...
                                                        <xsl:if test="contains(@expr, '?')">
                                                                ...
                                                                <xsl:attribute name="valueCondition">
                                                                    <xsl:choose>
                                                                        ...
                                                                        <xsl:otherwise><xsl:value-of select="$cond"/></xsl:otherwise>
                                                                    </xsl:choose>
                                                                </xsl:attribute>
        ...
        <xsl:template match="cml:ion_concentration" >
            <xsl:text>
    ...
    </xsl:text><xsl:element name="decayingPoolConcentrationModel">
                ...
                <xsl:attribute name="decayConstant">
                        <xsl:value-of select="cml:decaying_pool_model/@decay_constant"/> <xsl:value-of select="$timeUnits"/>
                </xsl:attribute>
        ...
        <xsl:template match="cml:synapse_type" >
            ...
            <xsl:choose>
                    ...
                    <xsl:when test="count(cml:blocking_syn) &gt; 0">
                            ...
                            <xsl:value-of select="$indent1_"/><xsl:element name="nmdaSynapse">
...
<xsl:text>
        ...
        <xsl:template match="cml:block" >
                ...
                <xsl:value-of select="$indent2_"/><xsl:element name="voltageConcDepBlock">
        ...
        <xsl:template match="cml:channel_type" >
            <xsl:value-of select="$indent1_"/><xsl:element name="ionChannel">
                        <xsl:attribute name="id">
                                <xsl:value-of select="@name"/>
                        </xsl:attribute>
                        ...
                        <xsl:choose>
                            <xsl:when test="@cond_law = 'ohmic'">
                                ...
                                <xsl:choose>
                                    ...
                                    <xsl:when test="count(cml:gate) = 0"><xsl:attribute name="type">ionChannelPassive</xsl:attribute></xsl:when>
                                    <xsl:otherwise>
...
<xsl:text>
        ...
        </xsl:text><xsl:element name="gate">
                        <xsl:attribute name="id"><xsl:value-of select="@name"/></xsl:attribute>
                        ...
                        <xsl:choose>
                            <xsl:when test="$gateType = 'gateHH'">
                                ...
                                <xsl:if test="count(../cml:offset) &gt; 0">
                                       <xsl:value-of select="$indent3"/><xsl:element name="notes">Note: offset from ChannelML file incorporated into midpoint of rates!!</xsl:element>
                                </xsl:if>
