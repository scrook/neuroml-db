...
# usage: python createLEMS.py ChannelFile.nml Na/Kv/Cav/Kca/Ih integrationDtInMs
    ...
    for subProtocolName in ["Activation", "Inactivation", "Deactivation"]:
        ...
        for step in range(steps):
            ...
            replacements = { \
                ...
                "[ClampID]": "Ca"+caConcShort+"_protocol"+subProtocolNameShort+"_step"+str(step),\
                "[CaConc]": caConc, \
        ...
        outFile = DirName + "/LEMS_" + caConcShort + "_" + subProtocolNameShort + "_" + FileName
